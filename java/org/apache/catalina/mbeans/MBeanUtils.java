...
/**
 * 该类就是通过Register实先了一系列的创建MBean的函数和销毁MBean的函数
...
public class MBeanUtils {
    ...
    public static DynamicMBean createMBean(ContextEnvironment environment)
        ...
        //通过ManagedBean创建MBean对象
        DynamicMBean mbean = managed.createMBean(environment);
        //创建ObjectName对象,ObjectName就是存储了domain域下的一些属性,ObjectName可以支持正则匹配
