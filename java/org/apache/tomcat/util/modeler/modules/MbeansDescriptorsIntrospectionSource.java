...
public class MbeansDescriptorsIntrospectionSource extends ModelerSource
{
    ...
    /**
     * 将realClass中的Method处理,存储在传入的参数map中
     *
                             ...
                             Hashtable<String,Method> invokeAttMap)
    {
        ...
        for (int j = 0; j < methods.length; ++j) {
            ...
            if( name.startsWith( "get" ) && params.length==0) {
                ...
                //将方法放入getAttMap中,key是方法名,value是对应的Method对象
    ...
    /**
     * 根据realClass对象通过反射的方法创建一个ManagedBean
                                         ...
                                         Class<?> realClass, String type)
    {
        ...
        try {
        	//遍历存储着函数的map,只有get,set函数
            Enumeration<String> en = attMap.keys();
            while( en.hasMoreElements() ) {
            	//获取属性名
                String name = en.nextElement();
                //封装属性成为AttributeInfo对象
