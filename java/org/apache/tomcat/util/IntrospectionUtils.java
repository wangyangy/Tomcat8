...
public final class IntrospectionUtils {
    ...
    public static boolean setProperty(Object o, String name, String value,
        ...
        try {
        	//根据反射获取相应的属性的set方法,根据反射找到对应参数类型,执行set方法
        	//例如server.xml解析时会将port="8005"的属性值设置到org.apache.catalina.core.StandardServer类的对象中。
            ...
            for (int i = 0; i < methods.length; i++) {
                ...
                if (setter.equals(methods[i].getName())
                    ...
                    //方法参数类型是Boolean,就进行类型转换后调用
                    } else if ("java.lang.Boolean".equals(paramType.getName())
                            || "boolean".equals(paramType.getName())) {
                        params[0] = Boolean.valueOf(value);

                    //方法参数类型是InetAddress,就获取InetAddress后调用
            ...
            //没有找到setXXX方法,则尝试setProperty("name", "value")
    ...
    public static Object getProperty(Object o, String name) {
        ...
        try {
            ...
            //没有找到getXXX函数,则尝试getProperty("name")
    ...
    /**
     * 先从缓存中查找字节码对象的Method数组,没有就通过反射获取Method数组
     * @param c
     * @return
     */
