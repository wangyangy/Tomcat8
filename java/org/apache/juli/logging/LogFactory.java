...
public class LogFactory {
	...
	//使用了单利设计模式,饿汉式,构造一个对象,用private static修饰,私有化构造方法,通过getInstance返回单利对象
    ...
    private LogFactory() {
        ...
        //ServiceLoader实现了Iterable接口,所以可以用增强for循环类迭代,遍历得到Log的具体实现类,
        //是在相应jar包中的META_INF/services/org.apache.juli.logging.Log文件中存储着
